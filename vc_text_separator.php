...
// Added below and in the TEMPLATE code below
$inline_css_fix = ( 'custom' === $color && '' !== $accent_color ) ? ' style="color: ' .  $accent_color . '"' : '';
